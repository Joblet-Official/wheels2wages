...
const base =
  'inline-flex items-center justify-center gap-2 font-semibold rounded-full transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-electric-700 focus-visible:ring-offset-2 focus-visible:ring-offset-white whitespace-nowrap select-none';

const variants: Record<Variant, string> = {
  primary:
    'bg-electric-700 text-white hover:bg-electric-800 active:bg-electric-900 shadow-glow-soft hover:shadow-glow',
  secondary:
